                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col md-6 col-xs-6 col-xl-6 col-sm-6">
                                            ...
                                            <select name="type_of_shares[]" class="form-control" required>
                                                <?php
                                                        if ($type_of_shares[$i] == "Preferred") { ?>
                                                    <option value="0">None</option>
                                                    <option>Common</option>
                                                    <option selected>Preferred</option>
                                                <?php } elseif ($type_of_shares[$i] == "Common") { ?>
                                                    <option value="0">None</option>
    ...
    <script>
        $(document).ready(function() {
            $("#add").click(function() {
                ...
                var held_position = $("<div class='col-md-10 col-xs-10 col-xl-10 col-sm-10'><input type='text' name='held_position[]' class='form-control' placeholder='Held Position'/></div>");
