...
<head>
    ...
    <title>Deleted Users - METRO PACIFIC INVESTMENT CORPORATION</title>
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <table id="tbl_users" class="table table-responsive table-hover" style="width:100%">
                    ...
                    <tbody>
                        <?php
                        $sql = "SELECT * FROM dbo.users_login WHERE CONVERT(NVARCHAR(MAX), is_deleted) = N'1' ORDER BY ID DESC";
                            ...
                            <tr>
                                ...
                                <td>
                                    <form method="POST">
                                        ...
                                        <button class="btn btn-warning" onclick="return confirmation()" name="restore_users" title="Restore"><i class="fa fa-undo"></i></button>
                                    </form>
                                </td>
                            </tr>
                        <?php } ?>
