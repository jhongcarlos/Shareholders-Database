...
<head>
    ...
    <title>Corporation List - Metro Pacific Investment Corporation</title>
    <style>
        .logo {
            display: block;
            margin-left: auto;
                        ...
                        <tbody>
                            ...
                            while ($row = sqlsrv_fetch_array($stmt, SQLSRV_FETCH_ASSOC)) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="v_corporation?corporation_name=<?= $row['corporation_name'] ?>"><button class="btn btn-primary" title="View"><i class="fa fa-eye"></i></button></a>
                                    </td>
                                </tr>
                            <?php } ?>
                        </tbody>
